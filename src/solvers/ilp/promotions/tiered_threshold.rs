...
use crate::{
    ...
    promotions::{
        ...
        types::{ThresholdDiscount, TieredThresholdPromotion},
    },
    solvers::{
        SolverError,
        ilp::{
...
impl ILPPromotionVars for TieredThresholdPromotionVars {
    ...
    fn add_constraints(
        ...
        // At most one tier active: sum(tier_t) <= 1
...
mod tests {
    ...
    fn budget_constraints_are_emitted() -> TestResult {
        ...
        // Tier-item link (1) + threshold spend (1) + application budget (1) + monetary budget (1) = 4
